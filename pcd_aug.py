...
parser.add_argument('--jittering', type=float, default=0.40, help='the probability of performing jittering (default: 0.40)')
parser.add_argument('--scaling', type=float, default=0.40, help='the probability of performing scaling (default: 0.40)')
parser.add_argument('--shifting', type=float, default=0.40, help='the probability of performing shifting (default: 0.40)')
parser.add_argument('--rotating', type=float, default=0.40, help='the probability of performing rotating (default: 0.40)')
parser.add_argument('--rgb_jittering', type=float, default=0.40, help='the probability of performing RGB jittering (default: 0.40)')
parser.add_argument('--rgb_light_effect', type=float, default=0.40, help='the probability of performing RGB light effect (default: 0.40)')
